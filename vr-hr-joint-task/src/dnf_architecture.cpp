...
std::shared_ptr<dnf_composer::Simulation> getDynamicNeuralFieldArchitectureHandMotion(const std::string& id, const double& deltaT)
{
	...
	element::GaussKernelParameters aol_aol_k_params = { 1, 1.5, -0.05, circularity, normalization };
	...
	element::GaussKernelParameters asl_asl_k_params = { 1, 1.5, -0.05, circularity, normalization };
