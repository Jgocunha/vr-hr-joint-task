    ...
    namespace tools
    {
        namespace logger
        {
            ...
            void Logger::log(const std::string& message) const
            {
                ...
                const std::string prefixStr = "<vr-hri> " + levelStr;
            ...
            ImVec4 Logger::getLogLevelColorCodeGui(LogLevel level)
            {
                ...
                case INFO:      return imgui_kit::colours::PastelBlue;  // White
                case WARNING:   return imgui_kit::colours::Yellow; // Yellow
                case ERROR:
                case FATAL:     return imgui_kit::colours::Red;    // Red
                default:        return imgui_kit::colours::PastelBlue;  // White
                }
            }
