...
double DnfComposerHandler::calculateHandDistanceToObjects(const Position& position)
{
	...
	static constexpr double tableCenterX = 0.0; // 0.075 (deprecated)
...
double DnfComposerHandler::normalizeHandPosition(double handPositionY)
{
	...
	static constexpr double yMin = -0.42; // -0.48 (deprecated)
	static constexpr double yMax = 0.42; // -0.42 (deprecated)
